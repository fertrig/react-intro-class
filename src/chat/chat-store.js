/*
 ...
 [] 5. Expose getter functions for state that store tracks
 ...
 [] 15. Move submitNewMessage to the flux pattern, remember that the store is already tracking the newMessage,
